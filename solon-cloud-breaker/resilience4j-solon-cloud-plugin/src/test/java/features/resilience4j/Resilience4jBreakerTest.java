 ...
 */
@SolonTest
public class Resilience4jBreakerTest implements Fallback<Void> {
    @Inject
    ...
    public static class DemoService1 {
        ...
        @CloudBreaker(name = "demo1", fallback = Resilience4jBreakerTest.class)
        public void test() {
            count.incrementAndGet();
