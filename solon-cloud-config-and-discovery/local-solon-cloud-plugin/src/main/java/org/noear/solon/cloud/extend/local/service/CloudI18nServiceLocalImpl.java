...
public class CloudI18nServiceLocalImpl implements CloudI18nService {
    ...
    static final String I18N_KEY_NO_GROUP = "i18n/%s-%s";
    ...
    public Pack pull(String group, String packName, Locale locale) {
        ...
        i18nKey = getI18nKey(group, packName, locale.getLanguage());
        ...
        i18nKey = getI18nKey(group, packName, locale);
        tmp = getI18nProps(i18nKey);
    ...
    public String getI18nKey(String group, String packName, Object locale) {
        if (Utils.isEmpty(group)) {
            return String.format(I18N_KEY_NO_GROUP, packName, locale);
        } else {
            return String.format(I18N_KEY_FORMAT, group, packName, locale);
        }
    }
}
